    ...
    <details open className="group">
      ...
      ">
        <span className="flex items-center gap-2">
          <svg className="w-4 h-4 md:w-5 md:h-5 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="mt-3 space-y-5 px-1">
        ...
        {/* Speed result */}
        {hasSpeed ? (
          <div className="bg-gradient-to-br from-brand-50 to-brand-100/50 dark:from-[#1a3225] dark:to-[#172c1e] border border-brand-200 dark:border-brand-800 rounded-xl p-4 md:p-5">
            ...
            <div className="flex items-baseline gap-4">
              <div>
                ...
                <span className="text-base md:text-lg font-semibold text-brand-500 ml-1">
                  {displayUnit === 'km' ? 'kph' : 'mph'}
                </span>
              </div>
              <div className="text-gray-400 dark:text-gray-600 font-light">·</div>
          ...
          <div className="text-sm text-gray-400 dark:text-gray-600 italic text-center py-2">
        ...
        {hasSpeed && (
          <div className="grid grid-cols-2 gap-3 text-sm md:text-base">
            <div className="bg-gray-50 dark:bg-[#152b1e] rounded-lg px-3 py-2.5">
              <p className="text-xs text-gray-400 dark:text-gray-500 mb-1">Flat pace (0% grade)</p>
            ...
            <div className="bg-gray-50 dark:bg-[#152b1e] rounded-lg px-3 py-2.5">
              <p className="text-xs text-gray-400 dark:text-gray-500 mb-1">Outdoor equiv ({grade}% grade)</p>
              <p className="font-semibold text-gray-700 dark:text-gray-200">
                {displayUnit === 'km'
                  ? `${paceToString(outdoorPaceKm)}/km`
                  : `${paceToString(outdoorPaceMi)}/mi`
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label htmlFor="grade-slider" className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
              Grade (Incline)
            </label>
            <span className="text-sm font-bold text-brand-600 dark:text-brand-400 bg-brand-50 dark:bg-[#152b1e] px-2 py-0.5 rounded-md">
              {grade.toFixed(1)}%
            </span>
          </div>
          <input
        ...
        {/* Speed unit toggle */}
        <div className="flex items-center justify-between">
          <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Speed Unit</span>
          <UnitToggle unit={displayUnit} onChange={onUnitChange} compact />
        </div>

        <p className="text-xs text-gray-400 dark:text-gray-600 leading-relaxed border-t border-gray-100 dark:border-border-dark pt-3">
          <strong className="text-gray-500 dark:text-gray-500">Note:</strong> Running at 1% treadmill grade is widely
